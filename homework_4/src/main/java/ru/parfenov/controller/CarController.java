...
public class CarController {
    ...
    @Autowired
    public CarController(CarService carService, UserService userService, CarDTOMapper dtoMapper) {
    ...
    private boolean checkCorrelation(HttpServletRequest request, int carId) {
        ...
        boolean nullCheck = user != null;
        return ownCheck || (
                nullCheck &&
                        (user.getRole().equals(UserRole.ADMIN) || user.getRole().equals(UserRole.MANAGER))
        );
    }
}