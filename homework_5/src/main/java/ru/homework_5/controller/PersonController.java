...
public class PersonController {
     ...
     * Параметры указываются в адресной строке запроса("/find-by_parameters?role=ADMIN&&name=.... и тд)
     * поиск можно проводить не по всем 4м параметрам. Некоторые можно не указывать после "=",
     * тогда они в отборе не участвуют (для параметра buysAmount в этом случае надо указать "buysAmount=-1").
     * Данный метод доступен только админу(через SecurityConfig)
     *
