...
public class AuditController {
    ...
    /**
     * Данный метод, доступный только админу(через SecurityConfig), позволяет посмотреть те логи,
     * которые сохранены в БД, отсортировав их по параметрам(указывать можно не все):
     * Параметры указываются в адресной строке запроса("/find-by_parameters?userId=2&&action=.... и тд)
     * поиск можно проводить не по всем 4м параметрам. Некоторые можно не указывать после "=",
     * тогда они в отборе не участвуют.
     *
